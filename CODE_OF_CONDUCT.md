...
We pledge to make participation in this project a welcoming and
...
This Code of Conduct applies within all project spaces -- the issue
tracker, pull requests, code review, the project chat if any, and any
other space where an individual is representing the project or its
community.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behaviour
may be reported to the project team at
`conduct@phm-vehicle.local`.  All complaints will be reviewed and
